...
1.  **Cài đặt cho Backend:**
    -   Di chuyển vào thư mục backend: `cd ten_thu_muc_du_an/backend`
...
3.  **Cấu hình Biến môi trường cho Backend:**
    ...
    -   Quay lại thư mục backend: `cd ../backend`
...
2.  **Dán nội dung sau vào file:**
    -   **LƯU Ý QUAN TRỌNG:**
        ...
        -   Bạn cần thay `/home/yourusername/ten_thu_muc_du_an/frontend/dist` bằng đường dẫn **CHÍNH XÁC** đến thư mục `dist` của bạn.
    ```nginx
    server {
        listen 80;
        ...
        root /home/yourusername/ten_thu_muc_du_an/frontend/dist;
        index index.html;
...
2.  **Khởi động ứng dụng:**
    -   Giả sử file khởi động của bạn là `server.js`.
    ```bash
