...
2.  **Chạy các file Migration cần thiết:**
    ...
    -   Chạy lần lượt các lệnh sau theo đúng thứ tự:
        ...
        \i /var/www/Ads-auto/backend/migrations/006_add_automation_tables.sql.txt
        
        -- Bảng cho tính năng Tăng tốc Ngân sách
        \i /var/www/Ads-auto/backend/migrations/007_add_budget_acceleration_tables.sql.txt
        ...
        \i /var/www/Ads-auto/backend/migrations/010_add_ai_copilot_conversations.sql.txt
        
        -- Bảng lưu trữ danh sách sản phẩm (Listing)
        \i /var/www/Ads-auto/backend/migrations/011_add_product_listings_table.sql.txt
        
        -- (MỚI) Bảng cho tính năng Lập lịch Tạo Campaign
        \i /var/www/Ads-auto/backend/migrations/012_add_campaign_creation_rules_table.sql.txt
        ```
